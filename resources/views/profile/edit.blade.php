                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group {{ Session::has('errors') && Session::get('errors')->has('cpf') ? 'has-error' : '' }}">
                                        ...
                                        <input id="cpf" type="text" class="form-control mask-cpf" name="cpf" value="{{ Auth::user()->getProfile->cpf }}">                                
                                        @if(Session::get('errors'))
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group {{ Session::has('errors') && Session::get('errors')->has('gender_id') ? 'has-error' : '' }}">
                                        ...
                                        <select style="height: 42px;" class="form-control" name="gender_id" id="gender_id">
                                            <option value=""></option>
                                            @foreach($gender as $g)
                                                <option value="{{ $g->id }}" {{ Auth::user()->getProfile->gender_id == $g->id ? 'selected' : '' }}>{{ $g->name }}</option>
                                            @endforeach
                                        </select>
                                        @if(Session::get('errors'))
                                    ...
                                    <div class="form-group {{ Session::has('errors') && Session::get('errors')->has('marital_id') ? 'has-error' : '' }}">
                                        ...
                                        <select style="height: 42px;" class="form-control" name="marital_id" id="marital_id">      
                                            ...
                                            @foreach($marital as $m)
                                                <option value="{{ $m->id }}" {{ Auth::user()->getProfile->marital_id == $m->id ? 'selected' : '' }}>{{ $m->name }}</option>
                                            @endforeach                                            
                                        </select>
                                        @if(Session::get('errors'))
                            ...
                            <div class="row">  
                                <div class="col-lg-4">
                                    <div class="form-group {{ Session::has('errors') && Session::get('errors')->has('zipcode') ? 'has-error' : '' }}">
                                        ...
                                        <input id="zipcode" type="text" class="form-control mask-zipcode" name="zipcode" value="{{ Auth::user()->getProfile->zipcode }}">                                
                                        @if(Session::get('errors'))
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group {{ Session::has('errors') && Session::get('errors')->has('state_id') ? 'has-error' : '' }}">
                                        ...
                                        <select style="height: 42px;" class="form-control" name="state_id" id="state_id">
                                            <option value=""></option>
                                            @foreach($state as $s)
                                                <option value="{{ $s->id }}" {{ Auth::user()->getProfile->getStateIdFormatted() == $s->id ? 'selected' : '' }}>{{ $s->name }}</option>
                                            @endforeach
                                        </select>
                                        @if(Session::get('errors'))
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group {{ Session::has('errors') && Session::get('errors')->has('city') ? 'has-error' : '' }}">
                                        ...
                                        <select style="height: 42px;" class="form-control" name="city_id" id="city_id" {{ Auth::user()->getProfile->city_id == null ? 'disabled' : '' }}>
                                            <option value=""></option>
                                            @if(Auth::user()->getProfile->city_id != null)
                                                @foreach($city as $c)
                                                    <option value="{{ $c->id }}" {{ Auth::user()->getProfile->city_id == $c->id ? 'selected' : '' }}>{{ $c->name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                        @if(Session::get('errors'))
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group {{ Session::has('errors') && Session::get('errors')->has('neighborhood') ? 'has-error' : '' }}">
                                        ...
                                        <input id="neighborhood" type="text" class="form-control" name="neighborhood" maxlength="50" value="{{ Auth::user()->getProfile->neighborhood }}">
                                        @if(Session::get('errors'))
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group {{ Session::has('errors') && Session::get('errors')->has('street') ? 'has-error' : '' }}">
                                        ...
                                        <input id="street" type="text" class="form-control" name="street" maxlength="100" value="{{ Auth::user()->getProfile->street }}">                                
                                        @if(Session::get('errors'))
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group {{ Session::has('errors') && Session::get('errors')->has('number') ? 'has-error' : '' }}">
                                        ...
                                        <input id="number" type="number" class="form-control" min="1" name="number" maxlength="5" value="{{ Auth::user()->getProfile->number }}">                                
                                        @if(Session::get('errors'))
                            ...
                            <div class="row">                            
                                <div class="col-lg-12">
                                    <div class="form-group {{ Session::has('errors') && Session::get('errors')->has('complement') ? 'has-error' : '' }}">
                                        ...
                                        <input id="complement" type="text" class="form-control" name="complement" maxlength="100" value="{{ Auth::user()->getProfile->complement }}">                                
                                        @if(Session::get('errors'))
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group {{ Session::has('errors') && Session::get('errors')->has('telephone') ? 'has-error' : '' }}">
                                        ...
                                        <input id="telephone" type="text" class="form-control mask-telephone" name="telephone" value="{{ Auth::user()->getProfile->telephone }}">                                
                                        @if(Session::get('errors'))
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group {{ Session::has('errors') && Session::get('errors')->has('cellphone') ? 'has-error' : '' }}">
                                        ...
                                        <input id="cellphone" type="text" class="form-control mask-cellphone" name="cellphone" value="{{ Auth::user()->getProfile->cellphone }}">                                
                                        @if(Session::get('errors'))
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group {{ Session::has('errors') && Session::get('errors')->has('whatsapp') ? 'has-error' : '' }}">
                                        ...
                                        <input id="whatsapp" type="text" class="form-control mask-cellphone" name="whatsapp" value="{{ Auth::user()->getProfile->whatsapp }}">                                
                                        @if(Session::get('errors'))
